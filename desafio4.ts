...
searchButton.addEventListener('click', async () => {
  try {
    ...
    let queryValor = query.value;
    let listaDeFilmes: any = await procurarFilme(queryValor);
...
let passowordValue: any = password.value;
let usernameValue: any = username.value;
let apiKeyValue: any = apiKey.value;


function preencherSenha(): void {
  password = passowordValue;
  validateLoginButton();
}
