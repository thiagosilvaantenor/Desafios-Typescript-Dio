...
searchButton.addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
    var lista, query, queryValor, listaDeFilmes, ul, _i, _a, item, li, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                queryValor = query.value;
                return [4 /*yield*/, procurarFilme(queryValor)];
            case 1:
...
var passowordValue = password.value;
var usernameValue = username.value;
var apiKeyValue = apiKey.value;
function preencherSenha() {
    password = passowordValue.toString();
    validateLoginButton();
}
